...
import org.xtext.example.ide.contentassist.antlr.PartialTerm_projectContentAssistParser;
import org.xtext.example.ide.contentassist.antlr.Term_projectParser;
import org.xtext.example.ide.contentassist.antlr.internal.InternalTerm_projectLexer;
import org.xtext.example.ui.contentassist.Term_projectProposalProvider;
import org.xtext.example.ui.editor.Term_projectEditor;
import org.xtext.example.ui.labeling.Term_projectDescriptionLabelProvider;
import org.xtext.example.ui.labeling.Term_projectLabelProvider;
import org.xtext.example.ui.outline.Term_projectOutlineTreeProvider;
import org.xtext.example.ui.quickfix.Term_projectQuickfixProvider;
import org.xtext.example.validation.Term_projectValidatorConfigurationBlock;

/**
 * Manual modifications go to {@link Term_projectUiModule}.
 */
@SuppressWarnings("all")
public abstract class AbstractTerm_projectUiModule extends DefaultXbaseUiModule {

	public AbstractTerm_projectUiModule(AbstractUIPlugin plugin) {
		super(plugin);
	}
	...
	public void configureHighlightingLexer(Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class)
			...
			.to(org.xtext.example.parser.antlr.internal.InternalTerm_projectLexer.class);
	}
	...
	public void configureContentAssistLexerProvider(Binder binder) {
		binder.bind(InternalTerm_projectLexer.class).toProvider(LexerProvider.create(InternalTerm_projectLexer.class));
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.validation.ValidatorFragment2
	public Class<? extends AbstractValidatorConfigurationBlock> bindAbstractValidatorConfigurationBlock() {
		return Term_projectValidatorConfigurationBlock.class;
	}
	...
	public Class<? extends ILabelProvider> bindILabelProvider() {
		return Term_projectLabelProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.labeling.LabelProviderFragment2
	public void configureResourceUIServiceLabelProvider(Binder binder) {
		binder.bind(ILabelProvider.class).annotatedWith(ResourceServiceDescriptionLabelProvider.class).to(Term_projectDescriptionLabelProvider.class);
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.outline.OutlineTreeProviderFragment2
	public Class<? extends IOutlineTreeProvider> bindIOutlineTreeProvider() {
		return Term_projectOutlineTreeProvider.class;
	}
	...
	public Class<? extends IssueResolutionProvider> bindIssueResolutionProvider() {
		return Term_projectQuickfixProvider.class;
	}
	
	// contributed by org.eclipse.xtext.xtext.generator.ui.contentAssist.ContentAssistFragment2
	public Class<? extends IContentProposalProvider> bindIContentProposalProvider() {
		return Term_projectProposalProvider.class;
	}
	...
	public Class<? extends XtextEditor> bindXtextEditor() {
		return Term_projectEditor.class;
	}
	...
	public Class<? extends IPartialEditingContentAssistParser> bindIPartialEditingContentAssistParser() {
		return PartialTerm_projectContentAssistParser.class;
	}
	...
	public void configureCompareViewerTitle(Binder binder) {
		binder.bind(String.class).annotatedWith(Names.named(UIBindings.COMPARE_VIEWER_TITLE)).toInstance("Term_project Compare");
	}
