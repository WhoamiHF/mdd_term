...
import org.xtext.example.ide.contentassist.antlr.internal.InternalTerm_projectParser;
import org.xtext.example.services.Term_projectGrammarAccess;

public class Term_projectParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(Term_projectGrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, Term_projectGrammarAccess grammarAccess) {
	...
	@Override
	protected InternalTerm_projectParser createParser() {
		InternalTerm_projectParser result = new InternalTerm_projectParser(null);
