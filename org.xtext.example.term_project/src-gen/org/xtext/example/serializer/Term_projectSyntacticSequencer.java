...
public class Term_projectSyntacticSequencer extends AbstractSyntacticSequencer {

	protected Term_projectGrammarAccess grammarAccess;
	...
	protected void init(IGrammarAccess access) {
		grammarAccess = (Term_projectGrammarAccess) access;
